...
export function ArchiveOverview({ projects }: { projects: Project[] }) {
  ...
  return (
    <>
      <section className="archive-overview archive-overview--desktop">
        ...
        <div className="archive-overview-mobile__grid">
          ...
          .map((project) => (
            <Link
              key={project.slug}
              href={`/projects/${project.slug}`}
              className="archive-overview-mobile__card"
            >
              {project.cardImage ? (
                <div className="archive-overview-mobile__image-wrap">
                  <img
                    src={project.cardImage}
                    alt=""
                    aria-hidden="true"
                    className="archive-overview-mobile__image"
                  />
                </div>
              ) : null}

              <div className="archive-overview-mobile__content">
